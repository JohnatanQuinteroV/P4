...
#Creamos una funcion utilizando la ya existente, con la diferencia del portador que tiene coseno
import numpy as np
...
#Creamos una funcion utilizando la ya existente, con la diferencia del portador que tiene seno
import numpy as np
...
# 7. Calcular número de errores
errores = sum(abs(bits_Tx - bits_Rx1))
BER = errores/len(bits_Tx)
print('{} errores, para un BER de {:0.4f}.'.format(errores, BER))
...
# ### 4.2. - Estacionaridad y ergodicidad -Respuesta
# 
# * (30%) Realice pruebas de estacionaridad y ergodicidad a la señal modulada `senal_Tx` y obtenga conclusiones sobre estas.
...
#El promedio temporal iguala al estadístico
#Los procedos independientes son no correlacionados
